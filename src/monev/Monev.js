...
export default function Monev({route, navigation}) {
  ...
  return (
    <NativeBaseProvider>
      ...
      <Header tit={'Monev'} nv={navigation} conf={conf} />
      ...
      <Text
        ...
        top={5}
        color={'white'}
        onPress={() => navigation.navigate('TambahMonev')}>
        Tambah Data
      </Text>
      <Box bg={'gray.100'} flex={1}>
        ...
        <FlatList
          ...
          renderItem={({item, index}) => (
            <Pressable
              onPress={() => navigation.navigate('DetailMonev')}
              key={index}>
              <Box
                mx={4}
                mb={4}
