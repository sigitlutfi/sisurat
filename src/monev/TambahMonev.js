...
export default function TambahMonev({route, navigation}) {
  ...
  const [form, setForm] = useState([
    ...
    {tipe: 'text', urai: 'Nama', wajib: true, isian: ''},
    {tipe: 'text', urai: 'Tes', wajib: true, isian: ''},
    {tipe: 'text', urai: 'Jabatan', isian: ''},
    {tipe: 'number', urai: 'No. Handphone', wajib: true, isian: ''},
    {tipe: 'text', urai: 'Email', isian: ''},

    {tipe: 'textarea', urai: 'Alamat Kantor', isian: ''},
  ]);
  ...
  return (
    <NativeBaseProvider>
      ...
      <KeyboardAvoidingView keyboardVerticalOffset={500} style={{flex: 1}}>
        {renderDate()}
        <Box h={'80%'} px={4} py={6} flex={1} bg={'gray.100'}>
          <Modal
            isOpen={mbigimg}
            onClose={() => {
              setMbigimg(false);
