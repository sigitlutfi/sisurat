...
export default function TambahTrafik({ route, navigation }) {
  ...
  const [form, setForm] = useState([
    {
      tipe: "date",
      urai: "Tanggal",
      isian: moment(new Date()).format("DD MM YYYYY"),
    },
        ...
        <HStack py={4} px={2} alignItems={"center"}>
          ...
          <Stack>
            <Heading color={"white"} ml={4} maxWidth={300} numberOfLines={1}>
              Lapor keadaan trafik
            </Heading>
            <Text ml={4} bold color={"white"}>
              Hari ini : {moment(new Date()).format("DD MMMM YYYY")}
            </Text>
          </Stack>
        </HStack>
      </Box>
