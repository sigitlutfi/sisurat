...
export default function TambahLapor({ route, navigation }) {
  ...
  const [form, setForm] = useState([
    { tipe: "textarea", urai: "Kronologi", isian: "" },
    { tipe: "text", urai: "Nomor Polisi" },
    ...
    <NativeBaseProvider>
      ...
      >
        <Modal.Content maxWidth="400px">
          ...
          <Modal.Body>
            <Text>Apakah data yang anda masukkan sudah benar ? </Text>
          </Modal.Body>
          <Modal.Footer>
