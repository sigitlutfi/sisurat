...
export default function Detaildesa({route, navigation}) {
  ...
  return (
    <NativeBaseProvider>
      <Header tit={'Detail Desa'} nv={navigation} conf={conf} />
      ...
      <Box bg={'gray.100'} flex={1}>
        <ScrollView>
          <Box
            ...
            <Stack>
              <Text color="white">Desa</Text>
              <Heading color="white">LATIUNG</Heading>
            </Stack>
          </Box>
